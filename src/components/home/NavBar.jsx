      ...
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <div class="hidden md:block">
            <div class="border w-fit rounded-xl shadow-sm">
              <button class="px-4 py-2 rounded-l-xl text-white m-0 bg-blue-500 hover:bg-blue-600   transition">
                Login
              </button>
          ...
          <button
            ...
            type="button"
            class="inline-flex items-center p-2 ml-1 text-sm text-gray-500 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 0"
        ...
        >
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
			...
			<div class="border mt-3 block md:hidden w-fit rounded-xl shadow-sm">
              <button class="px-4 py-2 rounded-l-xl text-white m-0 bg-blue-500 hover:bg-blue-600   transition">
                Login
              </button>
              <button class="px-4 py-2 rounded-r-xl bg-neutral-50 hover:bg-neutral-100 transition">
